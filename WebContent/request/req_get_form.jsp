...
<body>
	...
	<!-- form에 작성된 데이터를 서버로 전송할 떄, 받아서 처리할 URL정보를 action속성에 적습니다. -->
	
	<form action="req_get_parameter.jsp">
		<h3>회원가입 양식</h3>
		<hr/><!--밑줄  -->
		아이디: <input type="text" name="id" placeholder="아이디를 입력하세요" required ><br/>   <!-- ***기억잘하기***  -->
		...
		<br/>
		자기소개
		<textarea row="5" cols="30" name="txt"></textarea>
